...
<section class="content addContent " >
      ...
      <div class="row">
          <div class="col-lg-8">
              <div class="text-block">
                 ...
                 <div class="ml-5">
                  ...
                  <h4 class="mb-3">
                     This package is just PHP 1200 per person and starts with PHP 36,000
                  </h4>
               ...
               <div class="ml-5">
                ...
                <h4 class="mb-3">
                     This package is just PHP 1600 per person and starts with PHP 48,000
                  </h4>
               </div>
               <!--Package 3-->
               <p class="text-dark fw-light">
             ...
             <div class="ml-5">
              ...
              <p class="text-dark fw-light">
                ...
                <h4 class="mb-3">
                     This package is just PHP 1900 per person and start with PHP 57,000
                  </h4>
             </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 shadow ms-lg-4 rounded form_background" style="top: 100px;">
                  ...
                  <p class="text-muted">
                      <span class="h2">Anniversary Reservation</span>
              ...
              <form action="#" id="booking-form" class="form" method="post" autocomplete="off">
                ...
                <div class="mb-4">
                  <label for="guests" class="form_label">Guests*</label>
      ...
      <div class="row">
          <div class="col-lg-8">
              <div class="text-block">
                  ...
                  <p class="text-dark fw-light">
                    Celebrate your birthday with us with a great deals and satisfying and one of kind catering services.
          ...
          <div class="col-lg-4">
            <div class="p-4 shadow ms-lg-4 rounded form_background" style="top: 100px;">
                  ...
                  <p class="text-muted">
                      <span class="h2">Birthday Reservation</span>
